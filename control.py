...
def execute_command():
  ...
  match cmd_args.command:
    ...
    case "start_rasa_server":
      start_rasa_server(rasa_paths["rasa_exec_path_abs"], rasa_paths["working_dir_abs"])
    case "start_rasa_server_with_debug_logs":
      start_rasa_server_with_debug_logs(rasa_paths["rasa_exec_path_abs"], rasa_paths["working_dir_abs"])
